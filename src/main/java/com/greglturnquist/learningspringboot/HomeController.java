...
public class HomeController {
	...
	public String index(Model model, Pageable pageable) throws IOException {
		log.info(currentUser() + " is looking up all images");
	...
	public ResponseEntity<?> oneRawImage(@PathVariable String filename) {
		...
		log.info(currentUser() + " is looking up " + filename + "'s raw image");
		try {
	...
	public String createFile(@RequestParam("file") MultipartFile file,
		...
		log.info(currentUser() + " is uploading " + file.getOriginalFilename());
	...
	public String deleteFile(@PathVariable String filename,
							 RedirectAttributes redirectAttributes) {
		log.info(currentUser() + " is deleting " + filename);
		try {
